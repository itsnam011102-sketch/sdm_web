...
$count_query  = "SELECT COUNT(*) as total FROM employe" . $where;
    ...
    <div class="dashboard-shell">
        <aside class="sidebar">
            ...
            <div class="nav-group">
                ...
                <a class="nav-item active" href="data.php"><div class="nav-icon"><i class="bi bi-people-fill"></i></div><span>Data Pegawai</span></a>
