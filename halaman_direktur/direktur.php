        ...
        <div class="container-fluid max-width-lg">
            ...
            <form action="proses_tambah_kpi.php" method="POST"">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                               ...
                               <select name="divisi" id="divisi_select" class="form-select" required>
                           <option value="">-- Pilih Divisi --</option>    
                              <optgroup label="DIREKSI">
                            <option value="Direktur Operasional">Direktur Operasional</option>
                            <option value="Direktur Business">Direktur Business</option>
                           <option value="Direktur Utama">Direktur Utama</option>
                            ...
                            <div class="col-md-8">
                                <label class="form-label fw-semibold">Periode KPI</label>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <input type="hidden" name="perspektif_keuangan" value="perspektif_keuangan">
                            <table class="table table-hover table-bordered align-middle mb-0">
                                ...
                                <tbody id="body-keuangan">
                                    <tr>
                                        <td class="text-center row-no fw-bold text-secondary">1</td>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <input type="hidden" name="perspektif_pelanggan" value="perspektif_pelanggan">
                            <table class="table table-hover table-bordered align-middle mb-0">
                                <thead class="table-light text-center align-middle">
                                    <tr>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <input type="hidden" name="perspektif_proses_bisnis_internal" value="perspektif_proses_bisnis_internal">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            <input type="hidden" name="perspektif_pembelajaran_pertumbuhan" value="perspektif_pembelajaran_pertumbuhan">
                            <table class="table table-hover table-bordered align-middle mb-0">
                                <thead class="table-light text-center align-middle">
                                    <tr>
